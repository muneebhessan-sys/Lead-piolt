...
Start-Process powershell.exe -ArgumentList @('-NoExit', '-ExecutionPolicy', 'Bypass', '-Command', "Set-Location '$backend'; `$env:PYTHONPATH='.'; alembic upgrade head; uvicorn app.main:app --host 127.0.0.1 --port 8000")
